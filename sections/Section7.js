  ...
  return (
    <div ref={menuRef}>
      ...
      <div
        id="home"
        ref={ref}
        className="bg-vid  flex lg:pt-0 pt-14  flex-col-reverse lg:flex-row lg:space-x-8 lg:justify-around  justify-evenly items-center   w-screen lg:h-[70vh] h-[100vh]"
      >
        {/* main red box */}
        {/* image box */}
